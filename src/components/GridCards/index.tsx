  ...
  return (
    <div className="pt-[116px] px-6 h-auto relative flex flex-col gap-6">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        <div className="w-full h-80 flex flex-col justify-between items-center text-black dark:text-zinc-200  bg-zinc-300 hover:bg-zinc-400 dark:bg-darkMode-bg dark:hover:bg-darkMode-hover transition-colors rounded-lg p-10">
